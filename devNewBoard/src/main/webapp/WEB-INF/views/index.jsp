...
<div class="wrapper">
    ...
    <div class="breadcrumbs">
        <div class="container">
            <h1 class="pull-left">Look around, OneDay Class</h1>
            <ul class="pull-right breadcrumb">
                <li><a href="index.html">모든 클래스</a></li>
                <li><a href="">정규 클래스</a></li>
                <li class="active">원데이 클래스</li>
            </ul>
        </div>
    </div><!--/breadcrumbs-->
    <!--=== End Breadcrumbs ===-->
    ...
    <div class="container content blog-full-width">		
        ...
        <div class="blog margin-bottom-40">
            ...
            <h2><a href="blog_item_option1.html">Template comes with developer friendly and easy to customizable code</a></h2>
            <div class="blog-post-tags">
                <ul class="list-unstyled list-inline blog-info">
                    <li><i class="fa fa-calendar"></i> February 02, 2013</li>
                    <li><i class="fa fa-pencil"></i> Diana Anderson</li>
        ...
        <div class="blog margin-bottom-20">
            ...
            <h2><a href="blog_item_option1.html">Unify Template works on all main web browsers, tablets and phones.</a></h2>
            <div class="blog-post-tags">
                <ul class="list-unstyled list-inline blog-info">
                    <li><i class="fa fa-calendar"></i> February 02, 2013</li>
                    <li><i class="fa fa-pencil"></i> Diana Anderson</li>
